...
public final class ModBlocks {
    ...
    public static final DeferredBlock<CuddlyBlock> GRAY_SHARK_BLOCK = BLOCKS.register("gray_shark", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_WOOL).noOcclusion()
    ...
    public static final DeferredBlock<CuddlyBlock> BLAHAJ_BLOCK = BLOCKS.register("blue_shark", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_WOOL).noOcclusion()
    ...
    public static final DeferredBlock<CuddlyBlock> BLAVINGAD_BLOCK = BLOCKS.register("blue_whale", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_WOOL).noOcclusion()
    ...
    public static final DeferredBlock<CuddlyBlock> BREAD_BLOCK = BLOCKS.register("bread", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_WOOL).noOcclusion()
    ...
    public static final DeferredBlock<CuddlyBlock> BROWN_BEAR_BLOCK = BLOCKS.register("brown_bear", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_WOOL).noOcclusion()
    ...
    public static final DeferredBlock<CuddlyBlock> CAPYBARA_BLOCK = BLOCKS.register("capybara", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_WOOL).noOcclusion()
    ...
    static {
        for (String name : PRIDE_NAMES) {
            DeferredBlock<CuddlyBlock> block = BLOCKS.register(name + "_shark", () -> new CuddlyBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).noOcclusion()
